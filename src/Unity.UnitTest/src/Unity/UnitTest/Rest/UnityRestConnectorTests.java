...
public class UnityRestConnectorTests {
	...
	public void TestSetSettings() {
		...
		try {
			...
			RestConfigConnector.setSetting("app.config", "app/section1/random", Integer.toString(_testIntValue),
					SettingType.stInteger);

			value = RestConfigConnector.getSetting("app.config", "app/section1/firstname", "", SettingType.stString, false);
			intValue = Integer.parseInt(RestConfigConnector.getSetting("app.config", "app/section1/random", "",
					SettingType.stInteger, false));
	...
	public void TestGetSettings() {
		...
		try {
			...
			Stringvalue = RestConfigConnector.getSetting("app.config", "app/section1/firstname", "", SettingType.stString,
					false);
			intValue = Integer.parseInt(RestConfigConnector.getSetting("app.config", "app/section1/random", "",
					SettingType.stInteger, false));
