...
public class SettingsBase {
	...
	protected static int GetSettingWithMin (
	...
	protected static int GetSettingWithMax (
			String ConfigurationFileName, 
			String SettingPath, 
			int DefaultValue, 
			int MaxValue,
	...
	protected static int GetSetting(
			String ConfigurationFileName, 
			String SettingPath, 
			int DefaultValue, 
			boolean SetIfNotFound) {
		
		return Integer.parseInt(SettingsBase.GetSetting(ConfigurationFileName, SettingPath, Integer.toString(DefaultValue), SettingType.stInteger, SetIfNotFound));
		
	}
	
	protected static boolean GetSetting(
			String ConfigurationFileName, 
			String SettingPath, 
			boolean DefaultValue, 
			boolean SetIfNotFound) {
		
		return Boolean.parseBoolean(SettingsBase.GetSetting(ConfigurationFileName, SettingPath, Boolean.toString(DefaultValue), SettingType.stBoolean, SetIfNotFound));
		
	}
	
	protected static String GetSetting(
			String ConfigurationFileName, 
			String SettingPath, 
			String DefaultValue, 
			boolean SetIfNotFound) {
	...
	protected static String GetSetting(
		...
		String value = SettingsBase.GetCache().get(CacheKey); 
		
		// Value Cached?
		if (value == null) {

			// No; Read Configuration
	...
	protected static boolean SetSetting(
			String ConfigurationFileName, 
			String SettingPath, 
			int Value) {
	...
	protected static boolean SetSetting(
		...
		if (!SettingsBase.GetCache().containsKey(CacheKey) || 
			SettingsBase.GetCache().get(CacheKey) != Value) {
