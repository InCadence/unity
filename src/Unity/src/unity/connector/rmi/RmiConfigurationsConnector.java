...
public class RmiConfigurationsConnector{
	 ...
	 *********************/
	static {
		/*Use .NET Remoting to access the Singleton Configurations object
        ' that is hosted and remoted by the ConfigurationsService.  We
        ' do this in this static block because it only needs
        ' to be done once*/
