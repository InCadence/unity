...
/*-----------------------------------------------------------------------------'
 ...
 -----------------------------------------------------------------------------*/
public class UnityEncrypter implements IUnityEncrypter {
    ...
    public UnityEncrypter(String passPhrase) throws InvalidKeyException, NoSuchAlgorithmException,
    ...
    public Cipher getEncryptionCipher() throws UnityCryptoException
    {
        try
        {
        ...
        {
            throw new UnityCryptoException("getEncryptionCipher", e);
        }
    }

    public Cipher getDecryptionCipher() throws UnityCryptoException
    {
        try
        {
        ...
        {
            throw new UnityCryptoException("getDecryptionCipher", e);
        }
    }

    @Override
    public String decryptEntity(byte[] entityEncryptedBytes) throws UnityCryptoException
    {
        return decryptValue(entityEncryptedBytes);
    }

    @Override
    public String decryptEntity(String entityEncryptedBase64) throws UnityCryptoException
    {
        return decryptValue(entityEncryptedBase64);
    }

    @Override
    public byte[] encryptEntity(String entityXml) throws UnityCryptoException
    {
        return encryptValue(entityXml);
    }

    @Override
    public String encryptEntityToBase64(String entityXml) throws UnityCryptoException
    {
        return encryptValueToBase64(entityXml);
    }

    @Override
    public String decryptValue(byte[] valueEncryptedBytes) throws UnityCryptoException
    {
        ...
        {
            throw new UnityCryptoException("decryptValue", e);
        }
    }

    @Override
    public String decryptValue(String valueEncryptedBase64) throws UnityCryptoException
    {
    ...
    @Override
    public byte[] decryptValueToBytes(byte[] valueEncryptedBytes) throws UnityCryptoException
    {
        try
        {
    ...
    @Override
    public byte[] encryptValue(String value) throws UnityCryptoException
    {
        try
        {
    ...
    @Override
    public String encryptValueToBase64(String value) throws UnityCryptoException
    {
    ...
    @Override
    public byte[] encryptValue(byte[] valueBytes) throws UnityCryptoException
    {
        try
        {
        ...
        {
            throw new UnityCryptoException("encryptValue", e);
        }
    }
