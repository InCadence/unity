...
public class ConfigurationController {
    ...
    public ConfigurationValue getSetting(@RequestParam(value = "configurationFileName", required = true) String configurationFileName,
    ...
    public ConfigurationValue setSetting(@RequestParam(value = "configurationFileName", required = true) String configurationFileName,
                                         @RequestParam(value = "settingPath", required = true) String settingPath,
    ...
    public UnityLog log(@RequestParam(value = "logName", required = true) String logName,
